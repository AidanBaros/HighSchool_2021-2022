...
int main() {
	...
	do {
		...
		case 1:
			...
			cout << "To your east, you see a long hallway stretching out before you, and to your north, \nyou see the way you came in which you know you will not be able to exit until you defeat the skeleton king." << endl;
			maps[0][0] = (char)200;
			maps[0][1] = (char)205;
			map();
			cout << endl << endl;
		...
		case 3:
			...
			cout << "You see feel that you are near the middle of this hallway as the darkness to the west and east seem the same. " << endl;
			maps[0][4] = (char)205;
			maps[0][5] = (char)205;
			map();
			cout << endl << endl;
