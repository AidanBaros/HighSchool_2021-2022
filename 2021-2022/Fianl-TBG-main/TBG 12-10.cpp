...
int main() {
	...
	do {
		...
		case 1:
			...
			cout << "To your east, you see a long hallway stretching out before you, and to your north, \nyou see the way you came in which you know you will not be able to exit until you defect the skeleton king." << endl;
			maps[0][0] = (char)200;
			maps[0][1] = (char)205;
			map();
			cout << endl << endl;
		...
		case 2:
			...
			cout << "You see a three-way junction where the long hallway continues east, a path west back to the entrance of the maze, and a path going south." << endl;
			maps[0][2] = (char)203;
			maps[0][3] = (char)205;
			map();
			cout << endl << endl;
		...
		case 3:
			...
			cout << "You see feel that you are near the middle of this hallway as the darkness to the west and easy seem the same. " << endl;
			maps[0][4] = (char)205;
			maps[0][5] = (char)205;
			map();
			cout << endl << endl;
		...
		case 4:
			...
			cout << "You see the path leading east and west towards the entrance." << endl;
			maps[0][6] = (char)205;
			maps[0][7] = (char)205;
			map();
			cout << endl << endl;
		...
		case 5:
			...
			if (input.compare("pickup") == 0 && goldtf[0] == 0) {
				int c = rand() % 16 + 5;
		...
		case 10:
			...
			if (input.compare("pickup") == 0 && goldtf[1] == 0) {
				int c = rand() % 16 + 5;
				inventory[11].Quantity += c;
				goldtf[1] = 1;
				cout << "You found " << c << " gold" << endl;
		...
		case 11:
			...
			transform(input.begin(), input.end(), input.begin(), ::tolower);
			movement(input, 0, 1, 0, 1);
			if (input.compare("pickup") == 0 && goldtf[2] == 0) {
				int c = rand() % 16 + 5;
				inventory[11].Quantity += c;
				goldtf[2] = 1;
				cout << "You found " << c << " gold" << endl;
		...
		case 20:
			...
			if (input.compare("pickup") == 0 && keytf[0] == 0) {
		...
		case 28:
			...
			transform(input.begin(), input.end(), input.begin(), ::tolower);
			movement(input, 0, 1, 0, 1);
			if (input.compare("pickup") == 0 && goldtf[3] == 0) {
				int c = rand() % 16 + 5;
				inventory[11].Quantity += c;
				goldtf[3] = 1;
				cout << "You found " << c << " gold" << endl;
		...
		case 32:
			...
			transform(input.begin(), input.end(), input.begin(), ::tolower);
			movement(input, 0, 1, 1, 0);
			if (input.compare("pickup") == 0 && goldtf[4] == 0) {
				int c = rand() % 16 + 5;
				inventory[11].Quantity += c;
				goldtf[4] = 1;
				cout << "You found " << c << " gold" << endl;
		...
		case 33:
			...
			transform(input.begin(), input.end(), input.begin(), ::tolower);
			movement(input, 1, 0, 0, 1);
			if (input.compare("pickup") == 0 && goldtf[5] == 0) {
				int c = rand() % 16 + 5;
				inventory[11].Quantity += c;
				goldtf[5] = 1;
				cout << "You found " << c << " gold" << endl;
		...
		case 35:
			...
			movement(input, 1, 1, 0, 0);
			thingsforall(input);
			if (input.compare("pickup") == 0 && goldtf[6] == 0) {
				int c = rand() % 16 + 5;
				inventory[11].Quantity += c;
				goldtf[6] = 1;
				cout << "You found " << c << " gold" << endl;
		...
		case 49:
			...
			transform(input.begin(), input.end(), input.begin(), ::tolower);
			movement(input, 1, 0, 0, 1);
			if (input.compare("pickup") == 0 && goldtf[7] == 0) {
				int c = rand() % 16 + 5;
				inventory[11].Quantity += c;
				goldtf[7] = 1;
				cout << "You found " << c << " gold" << endl;
		...
		case 52:
			...
			if (input.compare("pickup") == 0 && goldtf[8] == 0) {
				int c = rand() % 16 + 5;
				inventory[11].Quantity += c;
				goldtf[8] = 1;
				cout << "You found " << c << " gold" << endl;
		...
		case 55:
			...
			transform(input.begin(), input.end(), input.begin(), ::tolower);
			movement(input, 1, 0, 0, 1);
			if (input.compare("pickup") == 0 && goldtf[9] == 0) {
				int c = rand() % 16 + 5;
				inventory[11].Quantity += c;
				goldtf[9] = 1;
				cout << "You found " << c << " gold" << endl;
		...
		case 62:
			...
			transform(input.begin(), input.end(), input.begin(), ::tolower);
			movement(input, 1, 0, 0, 1);
			if (input.compare("pickup") == 0 && goldtf[11] == 0) {
				int c = rand() % 16 + 5;
				inventory[11].Quantity += c;
				goldtf[11] = 1;
				cout << "You found " << c << " gold" << endl;
...
void combat() {
	...
	while (PlayerHealth >= 0 && MonHealth >= 0) {
		...
		int Attack = rand() % PlayerWeapon.BaseAttack + 1;
		int crit = rand() % 5;
